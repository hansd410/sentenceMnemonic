...
def batchify(batch):
	...
	# sangdo added
	sen_idx_list = [ex[6] for ex in batch]
	ans_sen_idx = [ex[7] for ex in batch]
...
#		raise RuntimeError('Incorrect number of inputs per example.')
	return x1, x1_c, x1_f, x1_mask, x2, x2_c, x2_f, x2_mask, sen_idx_list, ans_sen_idx, y_s, y_e, ids
